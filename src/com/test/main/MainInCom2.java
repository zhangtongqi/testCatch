...
public class MainInCom2 {

	public static final String FILE_DIR = "E://cde";
	public static final String BASE_HOST = "https://45maopp.com";
	public static final String CURRENT_PAGE = "/arthtml/18037.html";
	public static final int CURRENT_INDEX = 244;
	...
	public static String downloadPage(String url,final int titleIndex) {
		...
		Elements content = doc.select("div[class=content]").select("img");
		System.out.println(content);
		for (int i = 0; i < content.size(); i++) {
			final int index = i + 1;
			Element link = content.get(i);
			final String linkHref = link.attr("data-original");
